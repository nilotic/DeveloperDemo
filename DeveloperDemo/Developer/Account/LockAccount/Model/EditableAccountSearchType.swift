//
//  EditableAccountSearchType.swift
//
...
enum EditableAccountSearchType: CaseIterable {
    case userID
    case userNumber
    case email
    case phoneNumber
...
extension EditableAccountSearchType {
...
extension EditableAccountSearchType: RawRepresentable {
...
extension EditableAccountSearchType: Identifiable {
...
extension EditableAccountSearchType: Hashable {
...
extension EditableAccountSearchType: Equatable {
    
    static func ==(lhs: EditableAccountSearchType, rhs: EditableAccountSearchType) -> Bool {
        lhs.rawValue == rhs.rawValue
    }
}

extension EditableAccountSearchType: Encodable {
